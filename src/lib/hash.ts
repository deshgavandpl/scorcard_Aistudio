/**
 * Secure cryptographic hashing utility for passwords and PINs
 * Uses standard Web Crypto API with a robust pureJS SHA-256 fallback for non-secure contexts/iframes.
 */
...
export async function hashPassword(password: string): Promise<string> {
  ...
  try {
    ...
    console.warn('Web Crypto API error, falling back to pure JS SHA-255 algorithm', error);
  }
